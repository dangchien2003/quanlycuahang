        ...
        <div class="box">
            ...
            <div class="table-sv">
                <table class="table table-hover d-block">
                    <thead>
                        <tr>
                            <th scope="col" style="width: 5%;">Mã LK</th>
                            <th scope="col" style="width: 15%;">Tên linh kiện</th>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="../handle/thuhoispdaban.php?ma=<?php echo $row['malk'] ?>&banluc=<?php echo $row['banluc'] ?>&kh=<?php echo $row['tenkhachhang'] ?>&sl=<?php echo $row['soluong'] ?>&object=lk"
