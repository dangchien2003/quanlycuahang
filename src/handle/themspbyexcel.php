...
if ($excel_name) {
    ...
    if(!$inserted_row) {
        $return_status = 400;
        $return_message.= "Không thể thêm (Tên, Trạng thái là bắt buộc)";
    }
    ...
    header("Location: ../page/themmathang.php?status=$return_status&message=$return_message");
}else {
    header("Location: ../page/themmathang.php?status=400&message=Không thể lưu file");
}
